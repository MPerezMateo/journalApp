export class Categorias {
  ...
  static readonly crisisEcosocial = new Categorias('crisis ecosocial', 'leaf-outline', 'eco');
  ...
  static readonly deporte = new Categorias('deporte', 'basketball-outline', 'sport');
  ...
  static readonly coronavirus = new Categorias('coronavirus', 'flask-outline', 'corona');
